// pako stub: UTIF only needs it for Deflate-compressed TIFFs (rare in microscopy).
// If a Deflate TIFF appears, decoding throws a clear message instead of silently failing.
var self = (typeof self !== 'undefined') ? self : this;
self.pako = self.pako || { inflate: function(){ throw new Error('This TIFF uses Deflate compression, which is not supported in the report. Re-save as uncompressed or LZW TIFF.'); } };
